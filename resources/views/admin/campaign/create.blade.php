        ...
        <div class="p-6 bg-white rounded-md shadow-md">
            ...
            <div class="grid grid-cols-1 gap-6 mt-4">
                ...
                <div>
                    ...
                    <select class="w-full border bg-gray-200 focus:bg-white rounded px-3 py-2 outline-none" name="category_id" id="">
                ...
                <div>
                    ...
                    <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white p-3" type="number" name="target_donation" value="{{old('target_doantion')}}" placeholder="Target Domation, Ex: 10000000">
                ...
                <div>
                    <label class="text-gray-700" for="name">Tagggal Berakhir</label>
